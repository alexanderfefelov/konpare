...
object Config extends Subject {
  ...
  override def process2(data: List[String], model: collection.mutable.Map[String, String]) = {
    ...
    Parser.addPairsToModel(data, model, s"${Syntax.PREDICATE_DEBUG}=${Syntax.SUBJECT_CONFIG}")
  }
